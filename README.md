About pyiron_dataclasses-feedstock
==================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pyiron_dataclasses-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pyiron_dataclasses-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pyiron_dataclasses
# for installing globally
pixi global install pyiron_dataclasses
```
...
It is possible to list all of the versions of `pyiron_dataclasses` available on your platform:
...
```
pixi search pyiron_dataclasses --channel conda-forge
```
